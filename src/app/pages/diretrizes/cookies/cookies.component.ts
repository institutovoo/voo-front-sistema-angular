  ...
  secoes: DiretrizSecao[] = [
    ...
    },
    {
      ...
      conteudo: [
        ...
        'Para gerenciar cookies no seu navegador, acesse as configurações de privacidade ou segurança. Cada navegador possui métodos diferentes para gerenciar cookies.',
